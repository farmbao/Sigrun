...
/**
 * SegY file binary header definition
...
public class BinaryHeader {
    ...
    /* Number of auxilarity traces per ensemble. Mandatory for prestack data */
    @Reportable(value = "Number Of Auxilarity Traces Per Ensemble", startPosition = 14, endPosition = 16)
    private Short auxilarityTracesPerEnsemble;
    ...
    * */
    ...
    public Short getAuxilarityTracesPerEnsemble() {
        return auxilarityTracesPerEnsemble;
    }

    public void setAuxilarityTracesPerEnsemble(Short auxilarityTracesPerEnsemble) {
        this.auxilarityTracesPerEnsemble = auxilarityTracesPerEnsemble;
    }
    ...
    public String toString() {
        return "BinaryHeader:" +
                ...
                "\nauxilarityTracesPerEnsemble " + auxilarityTracesPerEnsemble +
